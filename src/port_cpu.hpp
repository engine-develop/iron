...
struct Timeout {
  ...
  static Timeout simpleTimeout(uint32_t timeout) {
    return Timeout(std::numeric_limits<uint32_t>::max(), timeout, 0, timeout, 0);
  }
...
public:
    ...
    * conditions for the serial port. \see Timeout
    *
    ...
    *    * The inter_byte_timeout component of Timeout defines the
    *      maximum amount of time, in milliseconds, between receiving bytes on
    *      the serial port that can pass before a timeout occurs.  Setting this
    *      to zero will prevent inter byte timeouts from occurring.
    *  * Total time timeout:
    *    * The constant and multiplier component of this timeout condition,
    *      for both read and write, are defined in Timeout.  This
    ...
    *      Timeout to 1000 and the read_timeout_multiplier to zero.
    ...
    * exception occurs.
    *
    * \param timeout A Timeout struct containing the inter byte
